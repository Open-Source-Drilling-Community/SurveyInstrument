...
class Program
{
    ...
    private static readonly string NAMESPACE = "OSDC.Drilling.SurveyInstrument.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
