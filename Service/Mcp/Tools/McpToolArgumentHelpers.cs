...
internal static class McpToolArgumentHelpers
{
    ...
    private static JsonObject SurveyInstrumentSchema(bool enforceModelFamily = false)
    {
        JsonObject schema = new()
        {
            ...
            ["CreationDate"] = NullableDateTime("Server-owned creation timestamp in ISO 8601 format. Any create input value is ignored."),
            ["LastModificationDate"] = NullableDateTime("Server-owned optimistic-concurrency token in ISO 8601 format. Any create input value is ignored."),
